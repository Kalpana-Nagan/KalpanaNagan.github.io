                ...
                <div className="col-sm-12 col-md-4">
                    ...
                    <div className="header card  box">
                        ...
                        <div className="container mt-2">
                            ...
                            <p><i className="fa fa-home fa-fw mr-3 lead text-info"></i>Bangalore, Karnataka</p>
                ...
                <div className="col-sm-12 col-md-8">
                    <div className="container card mb-4 box">
                        ...
                        <div className="container">
                            ...
                            <p>As a full stack developer, I work on React.js and Java.</p>
                            <hr/>
                        </div>
                        <div className="container mb-4">
                            ...
                            <p>As a Frontend web developer, developed responsive web application.</p>
                        </div>
                    </div>

                    <div className="container card mb-4 box">
                        <h2 className="header1 p-3"><i className="fa fa-certificate fa-fw mr-3 text-info"></i>Education</h2>
                        <div className="container">
                            <h5 className="header1"><b>SSLC</b></h5>
                            <h6 className="text-info"><i className="fa fa-calendar fa-fw mr-3"></i>2006 - 2007</h6>
        ...
        <footer className="container-fluid text-center bg-secondary text-white p-1">
            ...
            <ul className="list-inline m-0">
                <li className="list-inline-item">
                    <a className="text-light" rel="noopener noreferrer" href="" target="_blank">
                        <i className="fa fa-facebook-official lead"></i>
                    </a>
                </li>
                <li className="list-inline-item">
                    <a className="text-light" rel="noopener noreferrer" href="https://www.instagram.com/Kalpana_Nagan/" target="_blank">
                        <i className="fa fa-instagram lead"></i>
                    </a>
                </li>
                <li className="list-inline-item">
                    <a className="text-light" rel="noopener noreferrer" href="https://linkedin.com/in/kalpana-n-4b972577/" target="_blank">
                        <i className="fa fa-linkedin lead"></i>
                    </a>
                </li>
                <li className="list-inline-item">
                    <a className="text-light" rel="noopener noreferrer" href="" target="_blank">
                        <i className="fa fa-google-plus lead"></i>
                    </a>
                </li>
            </ul>
        </footer>
